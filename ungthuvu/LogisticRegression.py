...
#solver='lbfgs' sẽ sử dụng thuật toán L-BFGS để tối ưu hóa hàm mất mát khi huấn luyện mô hình hồi quy logistic
#max_iter là một tham số dùng để chỉ định số lượng vòng lặp tối đa mà thuật toán sẽ thực hiện trong quá trình
# tối ưu hóa hàm mất mát đatj giá trị hội tụ
...
# Giả sử bạn đã có mô hình đã huấn luyện (model) và giá trị x thực tế (x_real)
# x_real: giá trị x thực tế mà bạn muốn dự đoán giá trị y
# model: mô hình đã huấn luyện
# Dự đoán giá trị y dựa trên giá trị x thực tế
...
y_pred1 = model_LR.predict([x_real1])
...
y_pred2 = model_LR.predict([x_real2])
...
y_pred3 = model_LR.predict([x_real3])
