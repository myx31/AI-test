...
# Xác định số lượng hàng xóm (neighbors) và khởi tạo mô hình KNN
...
y_pred1 = knn_model.predict([x_real1])
...
y_pred2 = knn_model.predict([x_real2])
...
y_pred3 = knn_model.predict([x_real3])
